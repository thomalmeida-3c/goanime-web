...
type View = "search" | "episodes" | "player";
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      <header className="border-b border-neutral-800 px-6 py-4">
        <h1 className="text-xl font-semibold tracking-tight">GoAnime Web</h1>
        <p className="text-sm text-neutral-400">
          MVP: frontend Next.js consumindo o backend Go adaptado do GoAnime
        </p>
      </header>
          ...
          <>
            <form onSubmit={handleSearch} className="flex gap-2 mb-8">
              <input
                ...
                className="flex-1 rounded-md border border-neutral-700 bg-neutral-900 px-4 py-2 text-sm outline-none focus:border-neutral-500"
              />
              <button
                type="submit"
                disabled={loading}
